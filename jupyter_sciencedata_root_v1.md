Applying this manifest will start a **Jupyter Notebook server** with kernels for Python, R, Julia **and** ROOT.

The underlying Ubuntu container will have /cvmfs mounted and LCG software set up via the specified setup script, `SETUP_LCG`.
